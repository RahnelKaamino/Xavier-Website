...
<head>
    ...
    <title>Xavier University - Campus Map</title>
...
<body>
 ...
 <img id="pic" src="{{asset('assets\img\bg.jpg')}}"  class="img-fluid">
 <section class="">
     @include('about.structure-sidebar')
 <div class="col-sm-8">
    @include('about.structure-body')
 </section>
