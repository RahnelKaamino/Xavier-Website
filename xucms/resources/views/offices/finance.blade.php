...
<head>
    ...
    <title>Xavier University - Finance</title>
...
<body>
 ...
 <img id="pic" src="{{asset('assets\img\finance.jpg')}}"  alt="offices" border="0" width="100%" height="400px">
 <section class="">
     @include('offices.offices-sidebar')
 <div class="col-sm-8">
    @include('offices.finance-body')
 </section>
