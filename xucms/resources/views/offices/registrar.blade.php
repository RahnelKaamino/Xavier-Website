   ...
   <head>
       ...
       <title>Xavier University - Registrar</title>
   ...
   <body>
    ...
    <img id="pic" src="{{asset('assets\img\univregis.jpg')}}"  alt="offices" border="0" width="100%" height="400px">
    <section class="">
        @include('offices.offices-sidebar')
    <div class="col-sm-8">
       @include('offices.registrar-body')
    </section>
